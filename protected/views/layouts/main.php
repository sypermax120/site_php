    ...
    <div class="container">
            ...
            <aside class="col-md-3 hidden-xs hidden-sm">
                <div id="categories_block">
                    ...
                    <ul>
                        ...
                        <li><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/category.jpg">Доставка по Украине</li>
                ...
                <div id="discounts_block">
                    ...
                    <div class="comment_block">
                        <p>
                            ...
                            рассказали о ноутбуке Asus. Выбором ноутбука и условиями работы
                            доволен. Так держать.
                        </p>
                        <h6>Антон.</h6>
                    </div>
                    <div class="comment_block">
                        <p>
                            Огромное спасибо коллективу за отличную работу в 2020 году.
        ...
        <footer class="row">
            <div id="about_block" class="col-xs-7">
                <h6>Магазин техники «<span>MaxiShop</span>»</h6>
                <ul>
                    <li>Доставка</li>
                    <li>Оплата</li>
                    <li>Гарантия</li>
            ...
            <div id="design_block" class="col-xs-5">
                <h3>Created by Maks Pylypchak</h3>
            </div>
        </footer>
